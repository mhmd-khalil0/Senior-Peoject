...
<body>
  ...
  <h4 class="text-center">Coach Registration</h4>

    <div class="container">
      <form action="CoachPDO.php" method="Post">
        <div class="mb-3">
        ...
        <div class="mb-3">
          ...
          <input type="date" class="form-control" id="exampleInputdob" aria-describedby="emailHelp" name="dob">
        </div>
